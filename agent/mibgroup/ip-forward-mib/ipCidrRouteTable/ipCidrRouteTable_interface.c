...
_insert_filter(netsnmp_container *container, const void *data)
{
    ...
    const ipCidrRouteTable_rowreq_ctx *rowreq_ctx = data;
                                       ...
                                       char *contextName)
{
    ...
    if (asprintf(&container_name, "ipCidrRouteTable_%s:table_container",
    ...
    netsnmp_container_add_index(ipCidrRouteTable_if_ctx.container,
                                container );
