...
initialize_table_ipCidrRouteTable(void)
{
     ...
     */
    if (!ipCidrRouteTable_user_context_p)
	...
	(ipCidrRouteTable_user_context_p, flags, NULL);
}                               /* initialize_table_ipCidrRouteTable */

/**
 * Register the table ipCidrRouteTable with context
 */
void
register_table_ipCidrRouteTable(char *contextName)
{
    if (!ipCidrRouteTable_user_context_p)
        ipCidrRouteTable_user_context_p
	    = netsnmp_create_data_list("ipCidrRouteTable", NULL, NULL);
     ...
     */
    _ipCidrRouteTable_initialize_interface
	(ipCidrRouteTable_user_context_p, 0, contextName);
}                               /* register_table_ipCidrRouteTable */
