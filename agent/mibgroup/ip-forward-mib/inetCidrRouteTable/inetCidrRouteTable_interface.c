...
_insert_filter(netsnmp_container *container, const void *data)
{
    ...
    const inetCidrRouteTable_rowreq_ctx *rowreq_ctx = data;

    return match_vrf_to_id(vrf, rowreq_ctx->data->rt_vrf_table_id);
}
                                         ...
                                         char *contextName)
{
    ...
    if (asprintf(&container_name, "inetCidrRouteTable_%s:table_container",
    ...
    netsnmp_container_add_index(inetCidrRouteTable_if_ctx.container,
                                container );
