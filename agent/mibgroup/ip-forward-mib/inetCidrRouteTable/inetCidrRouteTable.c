...
initialize_table_inetCidrRouteTable(void)
{
     ...
     */
    if (!inetCidrRouteTable_user_context_p)
     ...
     * set any flags here.
     */
    flags = HANDLER_CAN_RWRITE;

    /*
     * call interface initialization code
     */
    _inetCidrRouteTable_initialize_interface
	(inetCidrRouteTable_user_context_p, flags, NULL);
...
/**
 * Register the table inetCidrRouteTable 
 */
void
register_table_inetCidrRouteTable(char *contextName)
{
    if (!inetCidrRouteTable_user_context_p)
        inetCidrRouteTable_user_context_p = 
	    netsnmp_create_data_list("inetCidrRouteTable", NULL, NULL);
     ...
     */
    _inetCidrRouteTable_initialize_interface
	(inetCidrRouteTable_user_context_p, HANDLER_CAN_RONLY, contextName);

}                               /* register_table_inetCidrRouteTable */
