...
initialize_table_ipDefaultRouterTable(void)
{
     ...
     */
    if (!ipDefaultRouterTable_user_context_p)
	...
	(ipDefaultRouterTable_user_context_p, flags, NULL);
}                               /* initialize_table_ipDefaultRouterTable */

/**
 * Register the table ipDefaultRouterTable 
 */
void
register_table_ipDefaultRouterTable(char *contextName)
{
    if (!ipDefaultRouterTable_user_context_p)
        ipDefaultRouterTable_user_context_p =
            netsnmp_create_data_list("ipDefaultRouterTable", NULL, NULL);
     ...
     */
    _ipDefaultRouterTable_initialize_interface
	(ipDefaultRouterTable_user_context_p, 0, contextName);
}                               /* register_table_ipDefaultRouterTable */
