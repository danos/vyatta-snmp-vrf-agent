...
initialize_table_ipAddressPrefixTable(void)
{
     ...
     */
    if (!ipAddressPrefixTable_user_context_p)
	...
	(ipAddressPrefixTable_user_context_p, flags, NULL);
}                               /* initialize_table_ipAddressPrefixTable */

/**
 * Register the table ipAddressPrefixTable 
 */
void
register_table_ipAddressPrefixTable(char *contextName)
{
    if (!ipAddressPrefixTable_user_context_p)
        ipAddressPrefixTable_user_context_p
	    = netsnmp_create_data_list("ipAddressPrefixTable", NULL, NULL);
    ...
    _ipAddressPrefixTable_initialize_interface
	(ipAddressPrefixTable_user_context_p, 0, contextName);
}                               /* register_table_ipAddressPrefixTable */
