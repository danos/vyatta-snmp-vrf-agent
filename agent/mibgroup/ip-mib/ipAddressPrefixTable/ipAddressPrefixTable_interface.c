...
_insert_filter(netsnmp_container *container, const void *data)
{
    ...
    const ipAddressPrefixTable_rowreq_ctx *rowreq_ctx = data;

    return vrf_compare(vrf, rowreq_ctx->vrf);
}
     ...
     char *contextName)
{
    ...
    if (asprintf(&container_name, "ipAddressPrefixTable_%s:table_container",
    ...
    netsnmp_container_add_index(ipAddressPrefixTable_if_ctx.container,
                                container );
