...
static int _ipAddressTable_compare(const void *lhs, const void *rhs)
{
    const ipAddressTable_rowreq_ctx *lh =
                                        (const ipAddressTable_rowreq_ctx *) lhs;
    const ipAddressTable_rowreq_ctx *rh =
                                        (const ipAddressTable_rowreq_ctx *) rhs;

    return _access_ipaddress_entry_compare_addr(lh->data, rh->data);
}
                              ...
                              netsnmp_cache * cache)
{
    ...
    *container_ptr_ptr =
    ...
    if (NULL != *container_ptr_ptr) {
        ...
        (*container_ptr_ptr)->compare = _ipAddressTable_compare;
    ...
    if ((NULL != rowreq_ctx) &&
        (MFD_SUCCESS ==
         ipAddressTable_indexes_set(rowreq_ctx,
                                    ...
                                    ipaddress_entry->ia_address_len))) {
        strcpy(rowreq_ctx->data->ia_vrf, ipaddress_entry->ia_vrf);
