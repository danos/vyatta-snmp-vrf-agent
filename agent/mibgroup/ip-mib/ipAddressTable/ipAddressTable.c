...
/**
 * Register the table ipAddressTable 
 */
void
register_table_ipAddressTable(char *contextName)
{
    ipAddressTable_user_context_p = NULL;
     ...
     * call interface initialization code
     */
    _ipAddressTable_initialize_interface(ipAddressTable_user_context_p,
                                         HANDLER_CAN_RONLY,
                                         contextName);
}                               /* register_table_ipAddressTable */
