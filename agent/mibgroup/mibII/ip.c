...
struct variable1 iproute_variables_ronly[] = {
    {IPROUTEDEST,    ASN_IPADDRESS, NETSNMP_OLDAPI_RONLY,
     var_ipRouteEntry, 1, {1}},
    {IPROUTEIFINDEX, ASN_INTEGER,   NETSNMP_OLDAPI_RONLY,
     var_ipRouteEntry, 1, {2}},
    {IPROUTEMETRIC1, ASN_INTEGER,   NETSNMP_OLDAPI_RONLY,
     var_ipRouteEntry, 1, {3}},
    {IPROUTEMETRIC2, ASN_INTEGER,   NETSNMP_OLDAPI_RONLY,
     var_ipRouteEntry, 1, {4}},
    {IPROUTEMETRIC3, ASN_INTEGER,   NETSNMP_OLDAPI_RONLY,
     var_ipRouteEntry, 1, {5}},
    {IPROUTEMETRIC4, ASN_INTEGER,   NETSNMP_OLDAPI_RONLY,
     var_ipRouteEntry, 1, {6}},
    {IPROUTENEXTHOP, ASN_IPADDRESS, NETSNMP_OLDAPI_RONLY,
     var_ipRouteEntry, 1, {7}},
    {IPROUTETYPE,    ASN_INTEGER,   NETSNMP_OLDAPI_RONLY,
     var_ipRouteEntry, 1, {8}},
    {IPROUTEPROTO,   ASN_INTEGER,   NETSNMP_OLDAPI_RONLY,
     var_ipRouteEntry, 1, {9}},
    {IPROUTEAGE,     ASN_INTEGER,   NETSNMP_OLDAPI_RONLY,
     var_ipRouteEntry, 1, {10}},
    {IPROUTEMASK,    ASN_IPADDRESS, NETSNMP_OLDAPI_RONLY,
     var_ipRouteEntry, 1, {11}},
    {IPROUTEMETRIC5, ASN_INTEGER,   NETSNMP_OLDAPI_RONLY,
     var_ipRouteEntry, 1, {12}},
    {IPROUTEINFO,    ASN_OBJECT_ID, NETSNMP_OLDAPI_RONLY,
     var_ipRouteEntry, 1, {13}}
};
...
init_ip(void)
{
    ...
    register_mib_context("mibII/ipaddr",
                         (struct variable *) ipaddr_variables,
                         sizeof(struct variable1),
                         sizeof(ipaddr_variables)/sizeof(struct variable1),
                         ipaddr_variables_oid,
                         sizeof(ipaddr_variables_oid)/sizeof(oid),
                         DEFAULT_MIB_PRIORITY, 0, 0, NULL,
                         NULL, -1, 0);

    register_mib_context("mibII/iproute",
                         (struct variable *) iproute_variables,
                         sizeof(struct variable1),
                         sizeof(iproute_variables)/sizeof(struct variable1),
                         iproute_variables_oid,
                         sizeof(iproute_variables_oid)/sizeof(oid),
                         DEFAULT_MIB_PRIORITY, 0, 0, NULL,
                         NULL, -1, 0);

    register_mib_context("mibII/ipmedia",
                         (struct variable *) ipmedia_variables,
                         sizeof(struct variable1),
                         sizeof(ipmedia_variables)/sizeof(struct variable1),
                         ipmedia_variables_oid,
                         sizeof(ipmedia_variables_oid)/sizeof(oid),
                         DEFAULT_MIB_PRIORITY, 0, 0, NULL,
                         NULL, -1, 0);

    (void) netsnmp_register_scalar_group(reginfo, IPFORWARDING, IPROUTEDISCARDS);
    /*
     * .... with a local cache
...
void
register_ip_context(char *contextName)
{
    netsnmp_handler_registration *reginfo;

    reginfo = netsnmp_create_handler_registration("ip", ip_handler, ip_oid,
                                    OID_LENGTH(ip_oid), HANDLER_CAN_RONLY);
    if (contextName)
    ...
    register_mib_context("mibII/iproute",
                         (struct variable *) iproute_variables_ronly,
                         sizeof(struct variable1),
                         sizeof(iproute_variables)/sizeof(struct variable1),
                         iproute_variables_oid,
                         sizeof(iproute_variables_oid)/sizeof(oid),
